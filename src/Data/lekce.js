export const lekce = [
  ...
  },
  {
    ...
    content: [
      ...
      {
        podtitulek: 'Co když jsem si vymyslel práci, která ještě neexistuje?',
        text: `Všechno, co si dokážeš dobře představit, existuje. To zní možná jako silná slova, proto ti to zkusím vysvětlit ještě jinak.
  ...
  },
  {
    ...
    content: [
      {
        podtitulek: 'Co mi dodává energii?',
        text: `Jak zjistit na co mám talent? To poznáš tak, že odhalíš, co ti dodává energii. Jasně, už slyším tvojí odpověď: „Spánek!“ Haha. Samozřejmě máš pravdu a kvalitní spánek je důležitý, avšak zaměř se na sebe teď, když jsi vzhůru.
        Co tě nabíjí? Co ti dodává energii?
        Napiš si všechno, co se ti teď vybavuje.`,
      },
      ...
      {
        titulek: 'Jak zjistit, v čem jsem dobrý?',
        text: `Vrátíme se k tomu podstatnému. Co jsou tvé silné stránky, talenty, jaký je tvůj potenciál? Člověk se rodí poskládaný z různých vlastností, povahových rysů a talentů. V tomto životě nemůže za to, s čím na svět přišel. Za co může je to, jak se svými talenty naloží. Ultimátní cíl zdravého života je:
        „Vědět o svých slabých stránkách a rozvíjet své talenty.“        
        `,
      },
      {
        podtitulek: 'Ptej se sám sebe: Co mi dodává energii?',
      ...
      {
        podtitulek: 'Ptej se ostatních: Co na mě obdivuješ?',
        text: `Když půjdeš po ulici a zeptáš se náhodného kolemjdoucího: „Co na mě obdivujete?,“ nejspíš se nesetkáš s pochopením, ale za ten vtípek to stojí. Musím to sám vyzkoušet. 😀
        Správně, asi tě napadá, že takovou otázku musíš položit někomu blízkému, komu důvěřuješ. Je zajímavé, že lépe si všímáme ostatních, než sami sebe. S velkou pravděpodobností se dozvíš něco opravdu cenného.
  ...
  },
  {
    ...
    content: [
      ...
      {
        podtitulek: 'Praxe na škole',
        text: `Odbornou školu si volíš tehdy, když se chceš něčemu naučit v praxi. Ptej se studentů na škole, jak u nich praxe probíhá. Kdo je učí? Učitel nebo odborník z oboru? Dokáže jim informace tak dobře předat, že jsou z toho nadšení? Jde škola s dobou a pracuje s nejmodernějšími technologiemi?
        Vždyť třeba ani nemáš v plánu vysokou a chceš hned po střední začít pracovat. Tehdy je kvalitní praxe dvakrát tak důležitá.
        `,
      },

      {
        podtitulek: 'Podporuje škola placené brigády v oboru?',
        text: `Teorie je jedna strana mince, kterou je třeba se naučit. Tou druhou je praxe. Co nejdříve to půjde, hledej brigádu v oboru. I kdyby byla hodinovka nižší, než práce v supermarketu, jdi do toho. Teprve usilovnou prací získáš ty nejcennější zkušenosti. `,
      },
      {
...

  {
    ...
    content: [
      ...
      Pokud ne tak proč si vůbec vybírám školu, která je pro mě tak náročná? Co mě k tomu motivuje?
      
      Třeba zjistíš, že motivace je tak obrovská, že to stojí i za to, ubrat si trochu pohodlí.
      `,
      },
    ],
  },
